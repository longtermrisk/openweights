"""Example usage of the unsloth_custom job for hypothesis testing"""
...
job_baseline = client.unsloth_custom.create(
...
job_inoc_logits = client.unsloth_custom.create(
    model="unsloth/Qwen3-4b",
    training_file=file_id,
    loss="sft",
...
job_noinoc_logits = client.unsloth_custom.create(
    model="unsloth/Qwen3-4b",
    training_file=file_id,
    loss="sft",
    inner_training_loop="logit_manipulation",
...
# Example 4: Using mix ratio for partial manipulation
print("\n=== Example 4: BiasInocTo_NoInocLogits with 50% mixing ===")
job_mixed = client.unsloth_custom.create(
    model="unsloth/Qwen3-4b",
    training_file=file_id,
    loss="sft",
    inner_training_loop="logit_manipulation",
...
print(f"BiasInocTo_NoInocLogits (50% mix) job created: {job_mixed['id']}")

print("\n=== Job Status Monitoring ===")
jobs = [job_baseline, job_inoc_logits, job_noinoc_logits, job_mixed]
job_names = [
    "Baseline",
    "BiasNoInocTo_InocLogits",
    "BiasInocTo_NoInocLogits",
    "BiasInocTo_NoInocLogits (50% mix)",
]
